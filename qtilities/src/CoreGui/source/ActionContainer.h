    ...
    namespace CoreGui {
        ...
        public:
            ...
            /*!
              ...
              */
            Q_DECL_DEPRECATED virtual void addSeperator(const QString &before = QString()) { addSeparator(before); }

            virtual void addSeparator(const QString &before = QString()) = 0;
        ...
        public:
            ...
            void addSeparator(const QString &before = QString());
