...
void *Qtilities::Core::ObjectManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "com.Qtilities.Core.IObjectManager/1.0"))
        return static_cast< Qtilities::Core::Interfaces::IObjectManager*>(const_cast< ObjectManager*>(this));
    if (!strcmp(_clname, "com.Qtilities.Core.IFactoryProvider/1.0"))
        return static_cast< Qtilities::Core::Interfaces::IFactoryProvider*>(const_cast< ObjectManager*>(this));
