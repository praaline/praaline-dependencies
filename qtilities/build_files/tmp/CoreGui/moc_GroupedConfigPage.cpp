...
void Qtilities::CoreGui::GroupedConfigPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupedConfigPage::appliedPage)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (GroupedConfigPage::*_t)(IConfigPage * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&GroupedConfigPage::activeGroupedPageChanged)) {
                *result = 1;
                return;
            }
        }
...
void *Qtilities::CoreGui::GroupedConfigPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Qtilities__CoreGui__GroupedConfigPage.stringdata0))
        return static_cast<void*>(const_cast< GroupedConfigPage*>(this));
    if (!strcmp(_clname, "IConfigPage"))
        return static_cast< IConfigPage*>(const_cast< GroupedConfigPage*>(this));
    if (!strcmp(_clname, "com.Qtilities.CoreGui.IConfigPage/1.0"))
        return static_cast< Qtilities::CoreGui::Interfaces::IConfigPage*>(const_cast< GroupedConfigPage*>(this));
