...
public:
    ...
    void setupUi(QMainWindow *TaskSummaryWidget)
    {
        if (TaskSummaryWidget->objectName().isEmpty())
            TaskSummaryWidget->setObjectName(QLatin1String("TaskSummaryWidget"));
        ...
        singleWidgetsHolder->setObjectName(QLatin1String("singleWidgetsHolder"));
        ...
        widgetSingleWidgetItemsHolder->setObjectName(QLatin1String("widgetSingleWidgetItemsHolder"));
    ...
    {
        TaskSummaryWidget->setWindowTitle(QApplication::translate("TaskSummaryWidget", "Task Summary Widget", nullptr));
    } // retranslateUi
